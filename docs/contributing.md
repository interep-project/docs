...
:tada: Thank you for being interested in contributing to the InterRep project! :tada:

Feel welcome and read the following sections in order to know how to ask questions and how to work on something.

All members of our community are expected to follow our [Code of Conduct](https://docs.interep.link/code-of-conduct). Please make sure you are welcoming and friendly in all of our spaces.
